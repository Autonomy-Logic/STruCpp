...
import {
  TypeChecker,
  ELEMENTARY_TYPES,
} from "../../src/semantic/type-checker.js";
  ...
  describe("TypeChecker", () => {
    ...
    describe("isTypeInCategory", () => {
      it("should identify ANY_INT types", () => {
        expect(
          typeChecker.isTypeInCategory(ELEMENTARY_TYPES["INT"]!, "ANY_INT"),
        ).toBe(true);
        expect(
          typeChecker.isTypeInCategory(ELEMENTARY_TYPES["DINT"]!, "ANY_INT"),
        ).toBe(true);
        expect(
          typeChecker.isTypeInCategory(ELEMENTARY_TYPES["REAL"]!, "ANY_INT"),
        ).toBe(false);
      });

      it("should identify ANY_REAL types", () => {
        expect(
          typeChecker.isTypeInCategory(ELEMENTARY_TYPES["REAL"]!, "ANY_REAL"),
        ).toBe(true);
        expect(
          typeChecker.isTypeInCategory(ELEMENTARY_TYPES["LREAL"]!, "ANY_REAL"),
        ).toBe(true);
        expect(
          typeChecker.isTypeInCategory(ELEMENTARY_TYPES["INT"]!, "ANY_REAL"),
        ).toBe(false);
      });

      it("should identify ANY_NUM types", () => {
        expect(
          typeChecker.isTypeInCategory(ELEMENTARY_TYPES["INT"]!, "ANY_NUM"),
        ).toBe(true);
        expect(
          typeChecker.isTypeInCategory(ELEMENTARY_TYPES["REAL"]!, "ANY_NUM"),
        ).toBe(true);
        expect(
          typeChecker.isTypeInCategory(ELEMENTARY_TYPES["BOOL"]!, "ANY_NUM"),
        ).toBe(false);
      });

      it("should identify ANY_BIT types", () => {
        expect(
          typeChecker.isTypeInCategory(ELEMENTARY_TYPES["BOOL"]!, "ANY_BIT"),
        ).toBe(true);
        expect(
          typeChecker.isTypeInCategory(ELEMENTARY_TYPES["BYTE"]!, "ANY_BIT"),
        ).toBe(true);
        expect(
          typeChecker.isTypeInCategory(ELEMENTARY_TYPES["WORD"]!, "ANY_BIT"),
        ).toBe(true);
        expect(
          typeChecker.isTypeInCategory(ELEMENTARY_TYPES["INT"]!, "ANY_BIT"),
        ).toBe(false);
      });
    });
